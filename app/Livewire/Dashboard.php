...
class Dashboard extends Component
{
    ...
    public function search()
    {
        ...
        ])->withOptions(['verify' => false])->get("http://172.26.226.129:8000/api/events/repeated-codes/{$this->codigo}");
        ...
        $additionalResponse = Http::withHeaders([
            'Authorization' => 'Bearer eZMlItx6mQMNZjxoijEvf7K3pYvGGXMvEHmQcqvtlAPOEAPgyKDVOpyF7JP0ilbK'
        ])->withOptions(['verify' => false])->get("http://172.26.226.129:8000/api/prueba/{$this->codigo}");
