<div class="section">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullName" name="fullName" class="form-control"
                            placeholder="Ej. César Rojas" wire:model="fullName" style="text-transform: uppercase;"
                            required>
                        @error('fullName')
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="5"
                            placeholder="Escribe aquí tu reclamación, sugerencia o incidencia" wire:model="description"
    ...
    <script>
        function recaptchaSuccess(token) {
            @this.set('recaptcha', token); // Asigna el token reCAPTCHA a la propiedad de Livewire
        }
    </script>
</div>
